...
class _MainScreenState extends State<MainScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
                        ...
                        Column(children: [
                         ...
                         onTap: (){
                           Navigator.push(
                               context,
                               MaterialPageRoute(
                                   builder: (context) => CensersScreen(widget.adminModel)
                               )
                           );
                         },
                         child: Padding(
                           ...
                           child: Container(
                            height:MediaQuery.of(context).size.height*0.19,
                             width:  widget.adminModel.typeAdmin!="superAdmin"?MediaQuery.of(context).size.width*0.75:MediaQuery.of(context).size.width*0.42 ,
                             decoration: BoxDecoration(
                                 borderRadius: BorderRadius.circular(20.0),
     ...
     widget.adminModel.typeAdmin!="superAdmin"?Container():       GestureDetector(
                onTap: (){
                  Navigator.push(
                      context,
                      MaterialPageRoute(
      ...
      widget.adminModel.typeAdmin!="superAdmin"?Container():      Text(
                "Ver Usuarios",
                style: TextStyle(
                    fontSize: 16.0,
                    fontWeight: FontWeight.bold
    ...
    widget.adminModel.typeAdmin!="superAdmin"?Container():        GestureDetector(
                onTap: (){
                  Navigator.push(
                               context,
                               MaterialPageRoute(
                                   builder: (context) => TaquillaAdmin(widget.adminModel)
                               )
                           );
                },
                child: Padding(
  ...
  floatingActionButton:  widget.adminModel.typeAdmin=="superAdmin"?Container():FloatingActionButton.extended(
        onPressed: () {
        ...
        backgroundColor:  widget.adminModel.saldoTaquilla<=199?Colors.red[600]:Colors.green[600],
      )
    );
  }
