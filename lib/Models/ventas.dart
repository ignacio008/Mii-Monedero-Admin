class VentasModel{
  ...
  VentasModel({this.id, this.storeId, this.nameOwner, this.numberOwner, this.nameStore, this.categoryStore, this.dateTime, this.userId, this.nameUser, this.state, this.locality, this.numberSales,  this.placa,this.nameRuta,});


  List  <VentasModel> getVentas(dynamic miInfo){
      List<VentasModel>iconmodelLits=[];
      ...
      VentasModel pagoModel = VentasModel(
        id: id_,
        storeId: storeId_,
